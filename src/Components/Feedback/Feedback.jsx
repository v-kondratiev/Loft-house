    ...
    return (
        <section className="feedback">
            <div className="container">
                <div className="feedback__title" data-aos="fade-right">
                    <h2 className="title-2">Have questions?</h2>
                </div>

                <form className="feedback__form form" >
                    <p className="form__privacy form__privacy--bottom" data-aos="fade-up">
                    ...
                    <input type="text" className="form__input" placeholder="Phone number" data-aos="fade-up"
                           data-aos-anchor-placement="center-bottom"/>
